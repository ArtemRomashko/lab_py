# Лабораторна робота №16: Робота з класами та файлами

## 1. Назва роботи
Лабораторна робота №4: Робота з класами та файлами

## 2. Мета роботи
Навчитись працювати з класами та файлами в мові програмування Python.

## 3. Опис завдання
Реалізувати класи `Task` та `Schedule` для роботи з завданнями. Клас `Task` має містити атрибути та методи для представлення завдання, перевірки термінів, серіалізації в JSON формат, десеріалізації з JSON формату, а також для зберігання та відстеження історії.

## 4. Виконання роботи
1. Створено папку `lab4`.
2. Додано файли:
...
### 5. Результати
Програма успішно реалізована і протестована згідно з очікуваними вимогами. Всі методи класів Task та Schedule працюють коректно, забезпечуючи потрібний функціонал для управління завданнями.

### 6. Висновки
Під час виконання лабораторної роботи ми навчились створювати класи, реалізувати методи для роботи з об'єктами цих класів, зберігати та відтворювати стан об'єктів за допомогою JSON-серіалізації, а також працювати з файлами для збереження та завантаження даних. Все це дозволило нам створити програму для управління завданнями з реалізацією різних операцій з ними, таких як додавання, видалення, оновлення, позначення завершеними, пошук за ключовим словом, сортування та інші операції.